...
"""
        },
        {
            ...
            "content": """
### 1. Synthèse exécutive et décryptage
Ancrage territorial de proximité, la commune de Mons-en-Barœul illustre les défis de la gestion urbaine dense en première couronne métropolitaine : rénovation urbaine, mixité sociale et transition écologique locale.
> « Penser la ville à hauteur d'habitant dans un tissu urbain dense et vivant. »
📌 **Sources :** Ville de Mons-en-Barœul, MEL.
---
### 2. Retours d'expérience opérationnels
* **Participation citoyenne :** Implication des conseils de quartier dans les projets d'aménagement.
* **Politique de la ville :** Dynamiques d'animation locale et cohésion sociale de proximité.
---
### 3. Pistes d'action pour l'encadrement
1. Croiser les retours d'expériences municipaux avec les grands enjeux métropolitains.
2. Décliner concrètement les politiques de transition à l'échelle des quartiers montois.
"""
        },
        {
            "code": "CUL-CIN",
            ...
            "content": """
### 1. Synthèse exécutive et décryptage
L'analyse des œuvres cinématographiques et télévisuelles exigeantes offre un regard acéré sur les mutations anthropologiques, politiques et sociologiques de notre époque contemporaine.
> « La fiction n'est pas un divertissement, c'est le laboratoire critique où s'expérimentent nos futurs collectifs. »
📌 **Sources :** Cahiers du Cinéma, Positif, revues spécialisées.
---
### 2. Retours d'expérience opérationnels
* **Esthétique de la narration :** Décryptage des formats longs et des structures narratives complexes.
* **Analyse critique :** Prise de recul face aux récits dominants et aux narrations institutionnelles.
---
### 3. Pistes d'action pour l'encadrement
1. Utiliser des études de cas issues de fictions complexes pour aborder la gestion de crise en management.
2. Cultiver l'esprit critique par le croisement des regards artistiques et sociologiques.
"""
        },
    ]
...
if st.button("Valider") or cmd:
    ...
    if clean_cmd == "VEILLE":
        ...
        if selected_sub:
            ...
            st.markdown("---")
            st.markdown(selected_sub["content"])
